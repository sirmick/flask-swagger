...
templates['signature'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.sampleJSON; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.events = {
      ...
      'dblclick .response': 'showResponseInNewWindow'
    };
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if ($("#username").val() === "" || $("#password").val() === "") {
        alert("Please enter your username and password at the top of the page");
        return false;
      }
      ...
      if (error_free) {
        ...
        obj = {
          ...
          beforeSend: function(xhr) {
            return xhr.setRequestHeader("Authorization", "Basic " + btoa($("#username").val() + ":" + $("#password").val()));
          }
        };
    ...
    OperationView.prototype.showResponseInNewWindow = function(e) {
      return window.open().document.write(this.data_response);
    };
    ...
    OperationView.prototype.showStatus = function(data) {
      ...
      this.data_response = data.responseText;
      try {
